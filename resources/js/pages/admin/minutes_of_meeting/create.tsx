...
import { Props } from '@/types/agenda';
                                            ...
                                            <CommandGroup>
                                                {agendas.map((agenda) => (
                                                    <CommandItem
                                                        ...
                                                        onSelect={() => {
                                                            setData('agenda_id', String(agenda.id));
                                                            setOpen(false);
                                                        }}
                                                    >
                                                        {agenda.title}
                                                        <Check
                                                            className={cn(
                                                                'ml-auto',
                                                                data.agenda_id === String(agenda.id) ? 'opacity-100' : 'opacity-0',
                                                            )}
                                                        />
                                                    </CommandItem>
                                                ))}
